...
import { X, Save, DollarSign, Clock, Tag, FileText, Edit } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200/50 bg-white/50 backdrop-blur-sm rounded-t-2xl flex-shrink-0">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gray-100/80 backdrop-blur-sm rounded-lg flex items-center justify-center">
